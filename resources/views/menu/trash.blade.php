                            ...
                            @forelse($menus as $m)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('menu.restore', $m->id) }}" class="btn btn-success btn-sm">

                                            <i class="fas fa-undo"></i>

                                        </a>

                                        <!-- <form action="{{ route('menu.forceDelete', $m->id) }}" method="POST"
                                         ...
                                         -->
                                <form action="{{ route('menu.forceDelete', $m->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
